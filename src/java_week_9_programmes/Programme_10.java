...
public class Programme_10 {
    public static void main(String[] args) {            // Main method
        String[] station = {"Aldgate", "Aldgate east", "Baker street", "Bank", "Barbican",
                ...
                "Earl's court", "Edgware road", "Elephant & Caslte", "Embankment", "Euston", "Euston square",
                "Farringdon", "Fenuchurch street", "Gloucester road", "Goodge street",
